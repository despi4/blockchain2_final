...
/// @title GameFiGovernor
/// @notice DAO governor for GameFi Economy protocol parameters.
///         Controls: drop rates, crafting costs, accepted item types, fee parameters.
///         All parameter changes go through a 2-day timelock before execution.
///
///         Block-based clock (default OZ behavior):
///           votingDelay  = 7 200 blocks ≈ 1 day  (at 12 s/block)
///           votingPeriod = 50 400 blocks ≈ 1 week
///           quorum       = 4% of total supply
///           threshold    = 1% of total supply
contract GameFiGovernor is
    Governor,
    GovernorSettings,
