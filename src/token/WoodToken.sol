...
contract WoodToken is ERC20, ERC20Burnable, AccessControl {
    /// @notice Role allowed to mint new WOOD.
    ...
    constructor(address admin, address initialRecipient, uint256 initialSupply) ERC20("Wood Token", "WOOD") {
        _grantRole(DEFAULT_ADMIN_ROLE, admin);
        _grantRole(MINTER_ROLE, admin);
        _mint(initialRecipient, initialSupply);
    }

    /// @notice Mints new WOOD tokens.
